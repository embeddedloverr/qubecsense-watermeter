...
// Installation rollout overview for one site. A superadmin section: mounted at
// /admin for a superadmin acting inside a site, and at
// /superadmin/sites/<slug>/overview against an explicit site.
...
export async function AdminOverview({
  siteId,
  subtitle = "Building-wide water meter rollout progress.",
  recordsHref = "/admin/installations",
}: {
  siteId: Types.ObjectId | string;
  subtitle?: string;
  /** Where "View all" points — differs between the two mounts. */
  recordsHref?: string;
}) {
  await connectDB();
