...
total already IS the final figure at that point. The table's own Total row
sums the same estimates for whatever's currently listed, narrowing with
search/filters the same way the real total already does.
